 ...
 * 
 */
public class GUIStoryShareDialogSpring extends Dialog {

	private static final String TAG = GUIStoryShareDialogSpring.class
			.getSimpleName();
	 ...
	 * @param context
	 */
	public GUIStoryShareDialogSpring(Context context) {
		super(context);
		initDialog();
	}
	 ...
	 * @param theme
	 */
	public GUIStoryShareDialogSpring(Context context, int theme) {
		super(context, theme);
		initDialog();
	}
	 ...
	 */
	public GUIStoryShareDialogSpring(Context context, boolean cancelable,
	...
	private void initDialog() {
		...
		setContentView(R.layout.dlg_storydetail_share_spring);
