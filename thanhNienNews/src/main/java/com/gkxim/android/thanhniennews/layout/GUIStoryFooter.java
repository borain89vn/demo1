 ...
 * @author Timon Trinh
 */
public class GUIStoryFooter extends LinearLayout implements
		View.OnClickListener {

	private static final String TAG = "GUIStoryFooter";
	 ...
	 * 03-01-2013
	 */
	public GUIStoryFooter(Context context) {
		super(context);
		initListViewItems();
	}
	 ...
	 * 03-01-2013
	 */
	public GUIStoryFooter(Context context, AttributeSet attrs) {
		super(context, attrs);
		initListViewItems();
	}
	 ...
	 */
	@SuppressLint("NewApi")
	public GUIStoryFooter(Context context, AttributeSet attrs, int defStyle) {
	...
	private void initListViewItems() {
		...
		inflate(getContext(), R.layout.bar_storydetail_footer, this);
