...
import com.gkxim.android.thanhniennews.layout.VideoStoryDetailFragment;
 ...
 * 
 */
public class VideoStoryDetailFragmentActivity extends FragmentActivity {

	private static final String TAG = "VideoStoryDetailFragmentActivity";
	...
	public static final String EXTRAKEY_STORY_TYPE_VIDEO = "media";
		...
		if (session != null && session.isOpened()) {
			if (checksharelikefb == 1) {
				...
				if (!mTabletVersion) {
					...
					VideoStoryDetailFragment frag = (VideoStoryDetailFragment) fm
	...
	protected void onCreate(Bundle arg0) {
		...
		if (intent != null) {
			...
			if (ACTION_STORY_VIEW.equalsIgnoreCase(action)) {
				...
				mStoryType = intent
						.getStringExtra(TNPreferenceManager.EXTRAKEY_STORY_FROM_VIDEO_SECTION);
			}
		}
	...
	private void initLayout() {
		setContentView(R.layout.activity_storydetail_video);
	...
	protected void updateStoryComment(VideoStoryDetailFragment frag,
			String storyid) {
		if (frag != null) {
	...
	public class StoryDetailPagerAdapter extends FragmentPagerAdapter {
		...
		public Fragment getItem(int position) {
			...
			return VideoStoryDetailFragment.create(mArrayStories[position]);
		}
		...
		public void destroyItem(ViewGroup container, int position, Object object) {
			GKIMLog.lf(null, 1, TAG + "=>destroyItem: " + position + ": "
					+ mArrayStories[position] + ": "
					+ ((VideoStoryDetailFragment) object).getStoryTitle());
			((VideoStoryDetailFragment) object).MyDestroy();
