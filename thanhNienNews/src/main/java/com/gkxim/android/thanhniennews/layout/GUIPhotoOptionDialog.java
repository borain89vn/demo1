 ...
 * 
 */
public class GUIPhotoOptionDialog extends Dialog {

	private static final String TAG = GUIPhotoOptionDialog.class
			.getSimpleName();
	 ...
	 * @param context
	 */
	public GUIPhotoOptionDialog(Context context) {
		super(context);
		initDialog();
	}
	...
	public void initDialog() {
		...
		setContentView(R.layout.dlg_photo_option);
