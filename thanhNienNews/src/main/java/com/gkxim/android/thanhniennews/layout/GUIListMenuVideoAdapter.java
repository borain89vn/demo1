...
public class GUIListMenuVideoAdapter extends BaseAdapter {
	 ...
	 * 28-11-2012
	 */
	public GUIListMenuVideoAdapter(Context context) {
		super();
		mContext = context;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(R.layout.menu_list_row_video, null);
			if (parent != null) {
	...
	private void setShowWebEvent(ViewHolder vh, boolean bShow) {
		if (vh != null) {
			try {
				...
				GKIMLog.l(4,
						TAG + "=>setShowWebEvent exception: " + e.getMessage());
			}
		}
	}
}
