...
public class GUIImageCache {
     ...
     */
    public GUIImageCache(ImageCacheParams cacheParams) {
        init(cacheParams);
    }
     ...
     */
    public GUIImageCache(Context context) {
     ...
     */
    public static GUIImageCache findOrCreateCache(
        ...
        GUIImageCache imageCache = (GUIImageCache) mRetainFragment.getObject();

        // No existing ImageCache, create one and store it in RetainFragment
        if (imageCache == null) {
            imageCache = new GUIImageCache(cacheParams);
    ...
    private void init(ImageCacheParams cacheParams) {
        ...
        if (mCacheParams.memoryCacheEnabled) {
            GKIMLog.l(0, TAG + "=> Memory cache created (size = " + mCacheParams.memCacheSize + ")");
                ...
                if (mCacheParams.diskCacheEnabled && diskCacheDir != null) {
                    ...
                    if (getUsableSpace(diskCacheDir) > mCacheParams.diskCacheSize) {
                        try {
                            ...
                            GKIMLog.l(0, TAG + "=> Disk cache initialized");
                        } catch (final IOException e) {
                            mCacheParams.diskCacheDir = null;
                            GKIMLog.l(4, TAG + "=> initDiskCache - " + e);
                        }
                    }
                }
            }
        ...
        synchronized (mDiskCacheLock) {
            ...
            if (mDiskLruCache != null) {
                ...
                try {
                	...
                	GKIMLog.l(4, TAG + "=> addBitmapToCache - " + e);
                } catch (Exception e) {
                	GKIMLog.l(4, TAG + "=> addBitmapToCache - " + e);
                } finally {
                    try {
    ...
    public Bitmap getBitmapFromMemCache(String data) {
        if (mMemoryCache != null) {
            ...
            if (memBitmap != null) {
            	GKIMLog.l(0, TAG + "=> Memory cache hit");
                return memBitmap;
            }
        }
        return null;
        ...
        synchronized (mDiskCacheLock) {
            ...
            if (mDiskLruCache != null) {
                ...
                try {
                    ...
                    if (snapshot != null) {
                    	GKIMLog.l(0, TAG + "=> Disk cache hit");
                	...
                	GKIMLog.l(4, TAG + "=> getBitmapFromDiskCache - " + e);
                } finally {
                    try {
                        if (inputStream != null) {
                            inputStream.close();
    ...
    public void clearCache() {
        if (mMemoryCache != null) {
            ...
            GKIMLog.l(0, TAG + "=> Memory cache cleared");
        }
        ...
        synchronized (mDiskCacheLock) {
            ...
            if (mDiskLruCache != null && !mDiskLruCache.isClosed()) {
                try {
                    ...
                    GKIMLog.l(0, TAG + "=> Disk cache cleared");
                } catch (IOException e) {
                	GKIMLog.l(4, TAG + "=> clearCache - " + e);
                }
                mDiskLruCache = null;
                initDiskCache();
            }
    ...
    public void flush() {
        synchronized (mDiskCacheLock) {
            if (mDiskLruCache != null) {
                try {
                    mDiskLruCache.flush();
                    GKIMLog.l(0, TAG + "=> Disk cache flushed");
                } catch (IOException e) {
            ...
            if (mDiskLruCache != null) {
                try {
                    if (!mDiskLruCache.isClosed()) {
                        mDiskLruCache.close();
                        mDiskLruCache = null;
                        GKIMLog.l(0, TAG + "=> Disk cache closed");
                    }
                } catch (IOException e) {
                	GKIMLog.l(4, TAG + "=> close - " + e);
                }
            }
        }
    }
    ...
    public static File getDiskCacheDir(Context context, String uniqueName) {
    	...
    	File exCacheDir = getExternalCacheDir(context);
        final String cachePath =
                (((Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState()) ||
                        !isExternalStorageRemovable()) && exCacheDir != null)? exCacheDir.getPath() :
    ...
    public static File getExternalCacheDir(Context context) {
        ...
        final String cacheDir = "/sdcard/Android/data/" + context.getPackageName() + "/cache/";
