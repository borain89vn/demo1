...
public class ImageDownloader {
	...
	private static final String TAG = "ARiseImageDownloader";
	...
	public void download(String url, ImageView imageView) {
		...
		if (cancelPotentialDownload(url, imageView)) {
			...
			//imageView.setAlpha((float)0.4); // set opacity for poster
	...
	static Bitmap downloadBitmap(String url) {
		...
		try {
			...
			if (statusCode != HttpStatus.SC_OK) {
				Log.e(TAG, String.format("Error %d while retrieving bitmap.", statusCode));
				return null;
			}
			...
			getRequest.abort();
			Log.e(TAG, "Error while retrieving bitmap from.");
		} finally {
			if (client != null) {
